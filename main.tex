...
We refer to the name-name and name-var problem as \emph{problem$_\nu$}
and refer to the var-var problem as \emph{problem$_\delta$}.
...
the substitution from the $\nu$-machine,
the var-var problems, $\delta$,
and a list of known variables.
is initialized by the domain of the substitution.
